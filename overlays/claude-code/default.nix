...
let
  ...
  nativeBin = fetchzip {
    ...
    hash = "sha256-/mNvDGt013tpSwWBDtONaW36xZPP149LXKByxxiARDs=";
  };
in
buildNpmPackage {
  pname = "claude-code";
  ...
  src = fetchzip {
    ...
    hash = "sha256-ucB+sPuzy6kxzUqYbtofmoDB9/If5EIjIi1uoRyHHfg=";
  };

  nativeBuildInputs = [ patchelf ];

  npmDepsHash = "sha256-FaQK7Vf9P8QXMEp88+GPYslf6CJ+zO9ApV9Bfd10N3o=";
