...
let
  ...
  nativeBin = fetchzip {
    ...
    hash = "sha256-t+/aX7AeLyo4DOdLiCYhdQn0b4tGXuIFwIEANbU682Y=";
  };
in
buildNpmPackage {
  pname = "claude-code";
  ...
  src = fetchzip {
    ...
    hash = "sha256-vTV2q82vyT9o2bYhZ/0+Qxnx/EhLwjKrb4ZHOhxeDE4=";
  };

  nativeBuildInputs = [ patchelf ];

  npmDepsHash = "sha256-TXHQOyfB3dLlFCmOugN6vllByLX+UI/hVL3h7D9VltI=";
