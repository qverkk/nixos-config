...
let
  ...
  sources = {
    x86_64-linux = fetchurl {
      url = "https://downloads.cursor.com/production/e589175333a2d938c3d944f9bf0993155e655e7f/linux/x64/Cursor-1.3.3-x86_64.AppImage";
      hash = "sha256-DoNjCbID0u4xz4jiKV5t1JkwpsXrCmPZCOICtU3xPpw=";
      # hash = lib.fakeSha256;
    };
  };
